...
@section('content')
    ...
    <div class="acss-inline-actions form-actions form-actions--inline" style="display:flex; width:100%; justify-content:flex-end; margin:1.15rem 0;">
        <button type="button" class="button button--primary button--inline" data-ta-show-edit-open>Edit Tahun Akademik</button>
        @if ($hasPeriods)
    ...
    <div class="acss-modal" data-ta-show-edit-modal role="dialog" aria-modal="true" aria-labelledby="ta-show-edit-modal-title" hidden>
        ...
        <div class="acss-modal__dialog acss-modal__dialog--master">
            <div class="acss-modal__head">
                <div>
                    <h3 class="acss-card-title" id="ta-show-edit-modal-title">Edit Tahun Akademik</h3>
                </div>

    ...
    return match ($role) {
        'admin' => [
            'navItems' => [
                ...
                ['label' => 'Import Dosen', 'href' => route('admin.import.dosen'), 'active' => 'admin.import.dosen', 'icon' => 'partials.icons.upload'],
                ['label' => 'Import Mahasiswa', 'href' => route('admin.import.mahasiswa'), 'active' => 'admin.import.mahasiswa', 'icon' => 'partials.icons.upload'],
            ],

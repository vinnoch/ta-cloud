...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:kaprodi'])->group(function () use ($page, $crudSideCards, $adminFields, $tableActionPair) {
    ...
    Route::get('/program-studi', function () use ($page, $tableActionPair, $crudSideCards) {
        return view('admin.program-studi.index', $page('admin', 'Program Studi', 'ADMIN • PROGRAM STUDI', [
            'rows' => [
                ['Sistem Informasi', 'S1', $tableActionPair('Detail', route('admin.program-studi.show', 1), 'Edit', route('admin.program-studi.edit', 1))],
                ['Teknik Informatika', 'S1', $tableActionPair('Detail', route('admin.program-studi.show', 2), 'Edit', route('admin.program-studi.edit', 2))],
            ],
    ...
    Route::get('/hak-akses', function () use ($page, $crudSideCards, $tableActionPair) {
        return view('admin.hak-akses.index', $page('admin', 'Hak Akses', 'ADMIN • HAK AKSES', [
            ...
            'rows' => [
                ['Kaprodi', 'Teknik Informatika', 'Modifikasi Dosen: Diizinkan', $tableActionPair('Detail', route('admin.hak-akses.show', 1), 'Edit', route('admin.hak-akses.edit', 1))],
                ['Kaprodi', 'Sistem Informasi', 'Modifikasi Dosen: Full', $tableActionPair('Detail', route('admin.hak-akses.show', 2), 'Edit', route('admin.hak-akses.edit', 2))],
            ],
    ...
    Route::get('/dosen', function () use ($page, $crudSideCards, $tableActionPair) {
        return view('admin.dosen.index', $page('admin', 'Data Dosen', 'ADMIN • DOSEN', [
            'rows' => [
                ['Dr. Sarah Wijaya', 'Sistem Informasi', 'Aktif', $tableActionPair('Detail', route('admin.dosen.show', 1), 'Edit', route('admin.dosen.edit', 1))],
                ['Dr. Bima Prakoso', 'Teknik Informatika', 'Aktif', $tableActionPair('Detail', route('admin.dosen.show', 2), 'Edit', route('admin.dosen.edit', 2))],
            ],
    ...
    Route::get('/mahasiswa', function () use ($page, $crudSideCards, $tableActionPair) {
        return view('admin.mahasiswa.index', $page('admin', 'Data Mahasiswa', 'ADMIN • MAHASISWA', [
            'rows' => [
                ['Adrian Sterling', 'Sistem Informasi', 'Aktif', $tableActionPair('Detail', route('admin.mahasiswa.show', 1), 'Edit', route('admin.mahasiswa.edit', 1))],
                ['Arya Wiguna Saputra', 'Sistem Informasi', 'Aktif', $tableActionPair('Detail', route('admin.mahasiswa.show', 2), 'Edit', route('admin.mahasiswa.edit', 2))],
            ],
    ...
    Route::get('/tahun-akademik', function () use ($page, $crudSideCards, $tableActionPair) {
        return view('admin.tahun-akademik.index', $page('admin', 'Tahun Akademik', 'ADMIN • TAHUN AKADEMIK', [
            'rows' => [
                ['2026 / 2027', '01 Aug 2026 - 31 Jul 2027', 'Aktif', $tableActionPair('Detail', route('admin.tahun-akademik.show', 1), 'Edit', route('admin.tahun-akademik.edit', 1))],
                ['2025 / 2026', '01 Aug 2025 - 31 Jul 2026', 'Arsip', $tableActionPair('Detail', route('admin.tahun-akademik.show', 2), 'Edit', route('admin.tahun-akademik.edit', 2))],
            ],
    ...
    Route::get('/periode', function () use ($page, $crudSideCards, $tableActionPair) {
        return view('admin.periode.index', $page('admin', 'Periode Akademik', 'ADMIN • PERIODE', [
            'rows' => [
                ['20261', '2026 / 2027', 'Aktif', $tableActionPair('Detail', route('admin.periode.show', 1), 'Edit', route('admin.periode.edit', 1))],
                ['20262', '2026 / 2027', 'Draft', $tableActionPair('Detail', route('admin.periode.show', 2), 'Edit', route('admin.periode.edit', 2))],
            ],
    ...
    Route::get('/format-penilaian', function () use ($page, $crudSideCards, $tableActionPair) {
        return view('admin.format-penilaian.index', $page('admin', 'Format Nilai', 'ADMIN • TEMPLATE NILAI', [
            'rows' => [
                ['Template Sidang 20261', '20261', 'Published', $tableActionPair('Detail', route('admin.format-penilaian.show', 1), 'Edit', route('admin.format-penilaian.edit', 1))],
                ['Template Sidang 20262', '20262', 'Draft', $tableActionPair('Detail', route('admin.format-penilaian.show', 2), 'Edit', route('admin.format-penilaian.edit', 2))],
            ],

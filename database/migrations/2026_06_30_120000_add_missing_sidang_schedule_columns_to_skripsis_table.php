...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('skripsis', function (Blueprint $table) {
            if (! Schema::hasColumn('skripsis', 'sidang_skripsi_datetime')) {
                $table->dateTime('sidang_skripsi_datetime')->nullable()->after('journal_article_url');
            }

            if (! Schema::hasColumn('skripsis', 'sidang_skripsi_grade_notified_at')) {
    ...
    public function down(): void
    {
        Schema::table('skripsis', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('skripsis', 'sidang_skripsi_datetime')) {
                $columns[] = 'sidang_skripsi_datetime';
            }

            if (Schema::hasColumn('skripsis', 'sidang_skripsi_grade_notified_at')) {
                $columns[] = 'sidang_skripsi_grade_notified_at';
            }
